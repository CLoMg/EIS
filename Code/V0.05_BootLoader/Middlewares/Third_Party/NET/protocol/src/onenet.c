...
//	else
//	{
//		window_start = 1000  * (Group_Info[1]-1);
//		window_stop = window_start + 1000;
...
//	if(SendList_Head->next != NULL)
//	{
//		struct SendMsg *p = SendList_Head->next; 
//		while(p->next != NULL)
//			p = p->next;
//		p->next = Msg;
//	}
