...
unsigned char Dir_Light_GPIO_Status_Get(void)
{
	...
	if((dir_light_status[0] == 0) &&(dir_light_status[2] == 0))
		return 0;
	else if((dir_light_status[0] == 1) &&(dir_light_status[2] == 0))
		return 1;
	else if((dir_light_status[0] == 0) &&(dir_light_status[2] == 1))
		return 2;
	else if((dir_light_status[0] == 1) &&(dir_light_status[2] == 1))
		return 3;
	else
		return 4;
}
