...
typedef enum func_code{
	...
	Light_Dir_Issue = 0x1048, Light_Dir_Query, DevPosi_Issue  = 0x1050, DevPosi_Query, LoraModule_Para_Set, LoraModule_Para_Query,Abnormal_Posi_Issue,Abnormal_Event_CLR,
}func_code_t;
